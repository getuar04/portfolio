...
const contactItems = [
  ...
  {
    key: "phone",
    value: "+383 43 833 571",
    href: "tel:+38343833571",
  ...
  {
    key: "linkedin",
    value: "linkedin.com/in/getuar-jakupi",
  ...
  {
    key: "github",
    value: "github.com/getuar04",
    href: "https://github.com/getuar04",
    color: { bg: "rgba(255,255,255,0.06)", text: "rgba(255,255,255,0.7)", border: "rgba(255,255,255,0.1)" },
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        <p
          ...
          style={{ color: item.highlight ? "#22d3ee" : item.href ? item.color.text : "rgba(255,255,255,0.8)" }}
        >
          {item.value}
          {item.highlight && (
            <span className="ml-2 text-xs" style={{ color: "rgba(34,211,238,0.5)" }}>📍</span>
          )}
        </p>
      </div>
      {item.href && (
        <svg className="w-4 h-4 shrink-0" style={{ color: "rgba(255,255,255,0.15)" }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        >
          ...
          <div className="relative grid lg:grid-cols-2 gap-10 lg:gap-12 items-start">
            ...
            <div>
              ...
              <p className="text-base leading-8 max-w-md" style={{ color: "rgba(255,255,255,0.55)" }}>
                {t.contact.sub}
              </p>
            </div>
