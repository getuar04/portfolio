...
export function Footer() {
  ...
  return (
    <footer className="py-8" style={{ borderTop: "1px solid var(--border)" }}>
      <div className="wrap flex flex-col sm:flex-row items-center justify-between gap-3 text-xs" style={{ color: "var(--ink-6)" }}>
        <p>
...
export function ScrollToTop() {
  ...
  return (
    ...
    >
      <svg className="w-5 h-5" style={{ color: "#fff" }} fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
